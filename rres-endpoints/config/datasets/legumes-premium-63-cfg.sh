...
# ROGER guard (2026-07-29). legumes-premium-common.sh predates the ROGER port: it still pins
...
# vegetables-premium had their -common.sh migrated to 2026.05.0 + the roger path; legumes did not.)
#
# Overridden HERE, after common.sh is sourced, rather than by editing common.sh -- versions 60/61/62

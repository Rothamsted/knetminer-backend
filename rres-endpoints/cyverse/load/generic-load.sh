...
"$CY_SCRIPTS_HOME/utils/knet-download.sh" "$data_url/rdf/ontologies/" "$onto_dir"
...
"$CY_SCRIPTS_HOME/utils/knet-download.sh" "$data_url/rdf/knowledge-graph.ttl.bz2" "$data_dir/${CY_DATASET_ID}.ttl.bz2"

...
The walk-through is mainly based on a dummy dataset OXL, which is an abstract of the real cereals dataset. It is available [here](https://knetminer.com/downloads/test/poaceae-sample.oxl) and created [from this Ondex plug-in](https://github.com/Rothamsted/knetbuilder/blob/master/ondex-knet-builder/modules/generic/src/main/java/net/sourceforge/ondex/transformer/RandomWalksSamplingPlugin.java).
